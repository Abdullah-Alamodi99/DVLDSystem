...
namespace DVLDSystem.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            ///     directly from your code. This API may change or be removed in future releases.
            /// </summary>
            [Required(ErrorMessage ="كملة المرور الحالية مطلوبه")]
            [DataType(DataType.Password)]
            [Display(Name = "كملة المرور الحالية")]
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"لا يمكن تحميل المستخدم بالمعرف '{_userManager.GetUserId(User)}'.");
            }
